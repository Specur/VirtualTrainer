...
<body>
	...
	<div id = "baner">
		...
		<div id="window">
			...
			<b>Witaj <?php  echo $_SESSION['imie']?>!</b><br/><br/>
Pamiętaj o uzupełnieniu swoich danych na bieżąco, abyśmy mogli mierzyć twoje postępy i ustalać diętę która będzie odpowiednia dla twoich aktualnych warunków fizycznych.<br/><br/>

<b>Dziękujemy za korzystanie z naszej strony ;)</b>
		</div>
